...
type userMockAPIClient struct {
	mu                 sync.RWMutex
	catalog            map[string]user.CatalogItem
	alternatingPresent bool
}

func NewUserMockAPIClient() *userMockAPIClient {
	client := &userMockAPIClient{
		catalog: make(map[string]user.CatalogItem),
	}
	client.seedExampleUsers()
	return client
}

func (client *userMockAPIClient) FetchCatalog(ctx context.Context) ([]user.CatalogItem, error) {
	client.mu.Lock()
...
func (client *userMockAPIClient) toggleAlternatingUsersLocked() {
	...
	client.catalog["192.168.1.100"] = user.CatalogItem{
		IP:   "192.168.1.100",
		Name: "DDDD",
	}
	client.catalog["192.168.1.101"] = user.CatalogItem{
		IP:   "192.168.1.101",
		Name: "ZZZZ",
	}
...
func (client *userMockAPIClient) seedExampleUsers() {
	...
	for _, item := range exampleUsers {
		client.catalog[item.IP] = item
	}
}

// createExampleUser1 creates the first example user
func createExampleUser1() user.CatalogItem {
	return user.CatalogItem{
		IP:   "192.168.1.10",
		Name: "Alice",
	}
}
...
func createExampleUser2() user.CatalogItem {
	return user.CatalogItem{
		IP:   "192.168.1.11",
		Name: "Bob",
	}
...
func createExampleUser3() user.CatalogItem {
	return user.CatalogItem{
		IP:   "192.168.1.12",
		Name: "Charlie",
	}
...
func createExampleUser4() user.CatalogItem {
	return user.CatalogItem{
		IP:   "192.168.1.13",
		Name: "Diana",
	}
...
func createExampleUser5() user.CatalogItem {
	return user.CatalogItem{
		IP:   "192.168.1.14",
		Name: "Eve",
	}
...
func createExampleUser6() user.CatalogItem {
	return user.CatalogItem{
		IP:   "192.168.1.15",
		Name: "Frank",
	}
...
func createExampleUser7() user.CatalogItem {
	return user.CatalogItem{
		IP:   "192.168.1.16",
		Name: "Grace",
	}
...
func createExampleUser8() user.CatalogItem {
	return user.CatalogItem{
		IP:   "192.168.1.17",
		Name: "Henry",
	}
...
func createExampleUser9() user.CatalogItem {
	return user.CatalogItem{
		IP:   "192.168.1.18",
		Name: "Iris",
	}
...
func createExampleUser10() user.CatalogItem {
	return user.CatalogItem{
		IP:   "192.168.1.19",
		Name: "Jack",
	}
...
func createExampleUser11() user.CatalogItem {
	return user.CatalogItem{
		IP:   "192.168.1.20",
		Name: "Kate",
	}
...
func createExampleUser12() user.CatalogItem {
	return user.CatalogItem{
		IP:   "192.168.1.21",
		Name: "Liam",
	}
...
func createExampleUser13() user.CatalogItem {
	return user.CatalogItem{
		IP:   "192.168.1.22",
		Name: "Mia",
	}
